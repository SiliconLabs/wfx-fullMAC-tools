...
#define SL_WIFI_STATUS_LIST(prefix)                                                                                                       \
  ...
  SL_STATUS_ENUM(prefix, SECURE_LINK_EXCHANGE_FAILED, 58),                                                                                \
  SL_STATUS_ENUM(prefix, SECURE_LINK_MAC_KEY_ERROR, 59),                                                                                  \
  SL_STATUS_ENUM(prefix, SECURE_LINK_DECRYPT_ERROR, 60),                                                                                  \
  SL_STATUS_ENUM(prefix, SECURE_LINK_KEY_RENEGOTIATION_ERROR, 61),
