...
#define IP_ADDR3   (uint8_t) 55  ///< Static IP: IP address value 3
...
#define GW_ADDR1   (uint8_t) 168      ///< Static IP: Gateway value 0 
#define GW_ADDR2   (uint8_t) 0        ///< Static IP: Gateway value 0 
#define GW_ADDR3   (uint8_t) 1        ///< Static IP: Gateway value 0 
