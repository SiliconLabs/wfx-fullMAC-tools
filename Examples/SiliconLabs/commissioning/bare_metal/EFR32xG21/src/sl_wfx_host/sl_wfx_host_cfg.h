...
#define SL_WFX_HOST_CFG_SPI_RX_DMA_SIGNAL   dmadrvPeripheralSignal_USART2_RXDATAV
#define SL_WFX_HOST_CFG_SPI_TX_DMA_SIGNAL   dmadrvPeripheralSignal_USART2_TXBL
