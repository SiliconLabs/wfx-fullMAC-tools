...
// <i> Default: 1
#define  NET_IPv4_CFG_LINK_LOCAL_EN                         0
...
// <i> Default: 1
#define  NET_DHCP_CLIENT_CFG_MODULE_EN                      0
