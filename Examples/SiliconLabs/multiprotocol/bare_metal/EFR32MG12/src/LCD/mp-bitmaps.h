...
#elif (PROT2 == PROT_WIFI)
#define PROT2_BITMAP      (wifiBitmap)
#define PROT2_BITMAP_CONN (wifiConnectedBitmap)
#endif // PROT1 | PROT2
static unsigned char wifiBitmap[] = {
...
static unsigned char wifiConnectedBitmap[] = {
