...
{
#if HAL_SPIDISPLAY_ENABLE
  dmpUiDisplayProtocol(DMP_UI_PROTOCOL2, connected);
#endif
}
...
{
#if HAL_SPIDISPLAY_ENABLE
  dmpUiDisplayProtocol(DMP_UI_PROTOCOL1, connected);
#endif
}
...
void interface_display_ble_id (uint8_t *id)
{
  ...
  dmpUiDisplayId(DMP_UI_PROTOCOL2, (uint8_t *)dev_id);
#endif
...
{
#if HAL_SPIDISPLAY_ENABLE
  dmpUiDisplayId(DMP_UI_PROTOCOL1, id);
#endif
}
