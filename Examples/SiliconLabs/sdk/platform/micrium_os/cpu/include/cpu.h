...
CPU_CORE_EXT CPU_TS_TMR CPU_IntDisMeasStart_cnts;               ///< Ints start time.
CPU_CORE_EXT CPU_TS_TMR CPU_IntDisMeasStop_cnts;                ///< Ints stop  time.
CPU_CORE_EXT CPU_TS_TMR CPU_IntDisMeasOvrhd_cnts;               ///< Ints       time meas ovrhd.
CPU_CORE_EXT CPU_TS_TMR CPU_IntDisMeasMaxCur_cnts;              ///< Ints    resetable max time dis'd.
CPU_CORE_EXT CPU_TS_TMR CPU_IntDisMeasMax_cnts;                 ///< Ints non-resetable max time dis'd.
#endif
 ...
 *                                               CPU_VAL_UNUSED()
 *
 * @brief    DEPRECATED. Macro used to prevent compiler warnings for unused parameters and variables.
 *
 * @param    val     variable or parameter generating the warning.
 *
 * @deprecated
 *******************************************************************************************************/
...
#error  "CPU_CFG_INT_DIS_MEAS_OVRHD_NBR not #define'd in 'cpu_cfg.h'. MUST be >= CPU_TIME_MEAS_NBR_MIN || <= CPU_TIME_MEAS_NBR_MAX."

#elif   (DEF_CHK_VAL(CPU_CFG_INT_DIS_MEAS_OVRHD_NBR, \
                     CPU_TIME_MEAS_NBR_MIN,          \
                     CPU_TIME_MEAS_NBR_MAX) != DEF_OK)
#error  "CPU_CFG_INT_DIS_MEAS_OVRHD_NBR illegally #define'd in 'cpu_cfg.h'. MUST be >= CPU_TIME_MEAS_NBR_MIN || <= CPU_TIME_MEAS_NBR_MAX."
