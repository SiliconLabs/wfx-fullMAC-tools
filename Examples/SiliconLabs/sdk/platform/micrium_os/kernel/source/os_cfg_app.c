...
CPU_STK_SIZE const OSCfg_IdleTaskStkLimit = ((OS_CFG_IDLE_TASK_STK_SIZE * OS_CFG_TASK_STK_LIMIT_PCT_EMPTY) / 100u);
...
#else
CPU_STK      *OSCfg_IdleTaskStkBasePtr = DEF_NULL;
CPU_STK_SIZE OSCfg_IdleTaskStkLimit = 0u;
CPU_STK_SIZE OSCfg_IdleTaskStkSize = 0u;
CPU_INT32U   OSCfg_IdleTaskStkSizeRAM = 0u;
#endif
#endif
...
CPU_STK_SIZE const OSCfg_TickTaskStkLimit = ((OS_CFG_TICK_TASK_STK_SIZE * OS_CFG_TASK_STK_LIMIT_PCT_EMPTY) / 100u);
...
#else
OS_RATE_HZ   OSCfg_TickRate_Hz = 0u;
OS_PRIO      OSCfg_TickTaskPrio = 0u;
CPU_STK      *OSCfg_TickTaskStkBasePtr = DEF_NULL;
CPU_STK_SIZE OSCfg_TickTaskStkLimit = 0u;
CPU_STK_SIZE OSCfg_TickTaskStkSize = 0u;
CPU_INT32U   OSCfg_TickTaskStkSizeRAM = 0u;
#endif
#endif
