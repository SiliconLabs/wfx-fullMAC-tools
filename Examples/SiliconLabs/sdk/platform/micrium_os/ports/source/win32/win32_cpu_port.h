...
#define  CPU_CFG_STK_ALIGN_BYTES  (16u)                         // Defines CPU stack alignment in bytes. (see Note #2).
...
#define  CPU_PORT_INIT

/********************************************************************************************************
 *                                   WIN32 CRITICAL SECTION CONFIGURATION
 *******************************************************************************************************/

#define  WIN32_CRITICAL_SECTION                             1u
#define  WIN32_MUTEX                                        2u  // Allow recursion of critical sections.
