...
#define ADDR_CRYPTOMASTER_REGS      (CRYPTOACC_BASE+0x00000000)
#define ADDR_BA431_REGS             (CRYPTOACC_BASE+0x00001000)
#define ADDR_BA414EP_REGS           (CRYPTOACC_BASE+0x00002000)
#define ADDR_BA431_FIFO             (CRYPTOACC_BASE+0x00004000)
#define ADDR_BA414EP_CRYPTORAM      (CRYPTOACC_BASE+0X00008000)
#define ADDR_BA414EP_UCODE          (CRYPTOACC_BASE+0X0000C000)
