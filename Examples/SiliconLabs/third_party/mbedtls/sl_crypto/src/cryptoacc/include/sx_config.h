...
#define ESEC_RAM_SIZE 131072

// Size (in bytes) of the eSecure system ROM
#define ESEC_ROM_SIZE 32768
...
// Include BA417 ChaCha20/Poly1305 engine
...
#define ECC_BINARY_ENABLED 1

// Support ECC with Edwards curves
#define ECC_EDWARDS_ENABLED 1
...
// Integrate PUF to generate SRK (PUF_TYPE=None)
