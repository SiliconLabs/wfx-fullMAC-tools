 ...
 */
uint32_t modular_addition(uint8_t *a, uint8_t *b, uint8_t *modulo,
      uint8_t *result, uint32_t size) CHECK_RESULT;
 ...
 *  @return CRYPTOLIB_SUCCESS when no error occurs.
 */
uint32_t modular_substraction(uint8_t *a, uint8_t *b, uint8_t *modulo, uint8_t
      *result, uint32_t size) CHECK_RESULT;
 ...
 *  @return CRYPTOLIB_SUCCESS when no error occurs.
 */
uint32_t modular_multiplication(uint8_t *a, uint8_t *b, uint8_t *modulo, uint8_t
      *result, uint32_t size) CHECK_RESULT;
 ...
 *  @return CRYPTOLIB_SUCCESS when no error occurs.
 */
uint32_t modular_reduction(uint8_t *a, uint8_t *modulo, uint8_t *result,
 ...
 *  @return CRYPTOLIB_SUCCESS when no error occurs.
 */
uint32_t modular_division(uint8_t *a, uint8_t *b, uint8_t *modulo, uint8_t
      *result, uint32_t  size) CHECK_RESULT;
 ...
 *  @return CRYPTOLIB_SUCCESS when no error occurs.
 */
uint32_t modular_inversion(uint8_t *a, uint8_t *modulo, uint8_t *result,
      uint32_t  size) CHECK_RESULT;
 ...
 *  @return CRYPTOLIB_SUCCESS when no error occurs.
 */
uint32_t multiplication(uint8_t *a, uint8_t *b, uint8_t *result, uint32_t size)
CHECK_RESULT;
 ...
 *  @return CRYPTOLIB_SUCCESS when no error occurs.
 */
 uint32_t modular_exponentiation(uint8_t *a, uint8_t *b, uint8_t *modulo,
       uint8_t *result, uint32_t size) CHECK_RESULT;
...
uint32_t ecc_point_inverse(block_t curve, block_t point, block_t result,
         uint32_t size, uint32_t curve_flags) CHECK_RESULT;
 ...
 * @param domain Curve parameters [input]
