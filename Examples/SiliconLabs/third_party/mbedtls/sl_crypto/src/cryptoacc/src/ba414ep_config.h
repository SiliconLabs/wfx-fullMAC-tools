...
#define BA414EP_STS_PRIM_LSB       (12)
#define BA414EP_STS_PRIM_MASK      (0x00001000)
#define BA414EP_STS_NINV_LSB       (11)
#define BA414EP_STS_NINV_MASK      (0x00000800)
#define BA414EP_STS_ABNV_LSB       (10)
#define BA414EP_STS_ABNV_MASK      (0x00000400)
#define BA414EP_STS_SINV_LSB       (9)
#define BA414EP_STS_SINV_MASK      (0x00000200)
#define BA414EP_STS_NOTIMPL_LSB    (8)
#define BA414EP_STS_NOTIMPL_MASK   (0x00000100)
#define BA414EP_STS_NNV_LSB        (7)
#define BA414EP_STS_NNV_MASK       (0x00000080)
#define BA414EP_STS_CPNV_LSB       (6)
#define BA414EP_STS_CPNV_MASK      (0x00000040)
#define BA414EP_STS_PINF_LSB       (5)
#define BA414EP_STS_PINF_MASK      (0x00000020)
#define BA414EP_STS_PNCU_LSB       (4)
#define BA414EP_STS_PNCU_MASK      (0x00000010)
#define BA414EP_STS_FADD_LSB       (0)
#define BA414EP_STS_FADD_MASK      (0x0000000F)

#define BA414EP_STS_ERROR_MASK     (0x0000FFF0)

/* Hardware configuration register */
#define BA414EP_HW_CFG_DISABLE_CM_LSB                       31
#define BA414EP_HW_CFG_DISABLE_CM_MASK                      (1L<<BA414EP_HW_CFG_DISABLE_CM_LSB)
#define BA414EP_HW_CFG_SUPPORT_255119_ACCEL_LSB             24
#define BA414EP_HW_CFG_SUPPORT_255119_ACCEL_MASK            (1L<<BA414EP_HW_CFG_SUPPORT_255119_ACCEL_LSB)
#define BA414EP_HW_CFG_SUPPORT_ECC_P192_ACCEL_LSB           23
#define BA414EP_HW_CFG_SUPPORT_ECC_P192_ACCEL_MASK          (1L<<BA414EP_HW_CFG_SUPPORT_ECC_P192_ACCEL_LSB)
#define BA414EP_HW_CFG_SUPPORT_ECC_P521_ACCEL_LSB           22
#define BA414EP_HW_CFG_SUPPORT_ECC_P521_ACCEL_MASK          (1L<<BA414EP_HW_CFG_SUPPORT_ECC_P521_ACCEL_LSB)
#define BA414EP_HW_CFG_SUPPORT_ECC_P384_ACCEL_LSB           21
#define BA414EP_HW_CFG_SUPPORT_ECC_P384_ACCEL_MASK          (1L<<BA414EP_HW_CFG_SUPPORT_ECC_P384_ACCEL_LSB)
#define BA414EP_HW_CFG_SUPPORT_ECC_P256_ACCEL_LSB           20
#define BA414EP_HW_CFG_SUPPORT_ECC_P256_ACCEL_MASK          (1L<<BA414EP_HW_CFG_SUPPORT_ECC_P256_ACCEL_LSB)
#define BA414EP_HW_CFG_SUPPORT_ECC_BINARY_LSB               17
#define BA414EP_HW_CFG_SUPPORT_ECC_BINARY_MASK              (1L<<BA414EP_HW_CFG_SUPPORT_ECC_BINARY_LSB)
#define BA414EP_HW_CFG_SUPPORT_ECC_PRIME_LSB                16
#define BA414EP_HW_CFG_SUPPORT_ECC_PRIME_MASK               (1L<<BA414EP_HW_CFG_SUPPORT_ECC_PRIME_LSB)
...
#define BA414EP_ADDR_MEMLOC(loc, size) ((uint8_t*)(ADDR_BA414EP_CRYPTORAM + \
