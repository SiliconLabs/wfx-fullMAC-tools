...
static uint32_t sx_trng_wait_startup(void)
{
   ...
   /**
    * @brief Will replace a rng source with data provided by the user (only for debug)
    *
    * \warning This function of code is not intended to be used in production, it is
    *          only for debugging purposes !
    * @param rng_source_new the new source of randomness
    */
   void sx_trng_set_alternative_rng_source(block_t *rng_source_new)
   {
      rng_source = rng_source_new;
   }

   /** @brief restore the randomness source to the TRNG output */
   void sx_trng_restore_rng_source()
   {
   ...
   /**
    * @brief Exists to match an existing function used to use user source of randomness
    *
    * \warning This function of code is not intended to be used in production.
    * @param rng_source_new the new source of randomness
    */
   void sx_trng_set_alternative_rng_source(block_t *rng_source_new)
   {
