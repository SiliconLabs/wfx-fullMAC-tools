                           ...
                           unsigned char output[16] )
{
    ...
    sx_ret = sx_aes_blk(ECB, dir, CTX_WHOLE, key, NULL_blk, NULL_blk, data_in,
			data_out, NULL_blk, NULL_blk, NULL_blk, NULL_blk);
                           ...
                           unsigned char *output )
{
    ...
    sx_ret = sx_aes_blk(CBC, dir, CTX_MIDDLE, key, NULL_blk, iv_block, data_in,
			data_out, NULL_blk, NULL_blk, iv_block, NULL_blk);
    cryptoacc_management_release();
    ...
    while ( processed < length ) {
        if ( n > 0 ) {
            ...
            if ( iterations > 0 ) {
		        ...
		        sx_ret = sx_aes_blk(CFB, dir, CTX_MIDDLE, key, NULL_blk,
				                    iv_block, data_in, data_out,
				                    NULL_blk, NULL_blk, iv_block, NULL_blk);
     	        cryptoacc_management_release();
    ...
    while ( processed < length ) {
        if ( n > 0 ) {
            ...
            if ( iterations > 0 ) {
                ...
                sx_ret = sx_aes_blk(CTR, dir, CTX_MIDDLE, key, NULL_blk,
				                    iv_block, data_in, data_out,
				                    NULL_blk, NULL_blk, iv_block, NULL_blk);
                cryptoacc_management_release();
