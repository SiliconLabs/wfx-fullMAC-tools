 ...
 */
extern const wf200_pds_t wf200_config_table[];
...
sl_status_t wf200_start_ap_command( uint32_t channel, uint8_t* ssid, uint32_t ssid_length, wfm_security_mode security, const uint8_t* passkey, uint8_t passkey_length );
