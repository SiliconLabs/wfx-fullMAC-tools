...
#define  EX_NET_CORE_IF_ETHER_MAC_ADDR                      "00:17:4A:B0:00:01"
#endif
...
#define  EX_NET_CORE_IF_ETHER_IPv4_STATIC_ADDR              "192.168.2.111"
#endif
...
#define  EX_NET_CORE_IF_ETHER_IPv4_STATIC_GATEWAY           "192.168.2.1"
#endif
...
void Ex_Net_CoreInit(void)
{
  ...
  /* Change the TCP/IP net core task's priority for the bridge function */
  Net_CoreTaskPrioSet(NET_CORE_TASK_CFG_PRIO, &err);
  APP_RTOS_ASSERT_CRITICAL((err.Code == RTOS_ERR_NONE),; );
